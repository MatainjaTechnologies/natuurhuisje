...
export default function StayDetailPage() {
  ...
  useEffect(() => {
    if ((listing.price_per_night > 0 || (listing.special_pricing?.length ?? 0) > 0) && checkIn && checkOut) {
          ...
          <div className="lg:col-span-2">
            ...
            <div className="mb-8">
                  ...
                  <div className="flex items-center gap-4 text-sm text-gray-600">
                    <div className="flex items-center gap-1">
                      ...
                      <span className="font-semibold">
                        {listing.rating || listing.avg_rating || 4.5}
                      </span>
                      <span>
                        ({listing.reviews_count} {t.reviews.reviews})
                      </span>
                    </div>
                    <div className="flex items-center gap-1">
              ...
              <div className="flex items-center gap-6 text-gray-700 border-b border-gray-200 pb-6">
                <span>
                  {listing.max_person} {t.details.guests}
                </span>
                <span>·</span>
                <span>
                  {listing.bedrooms} {t.details.bedrooms}
                </span>
                <span>·</span>
                <span>
                  {listing.beds} {t.details.beds}
                </span>
                <span>·</span>
                <span>
                  {listing.bathrooms} {t.details.bathrooms}
                </span>
              </div>
            </div>
                      ...
                      return (
                        <>
                          ...
                          {hasSpecialPricing ? (
                            ...
                            <div className="flex justify-between text-sm">
                              <span className="text-gray-600">
                                €{listing?.price_per_night || 0} x {nights} {t.details.nights}
                              </span>
                              <span className="text-gray-900">€{subtotal}</span>
                            </div>
                          )}
