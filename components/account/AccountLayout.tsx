...
export function AccountLayout({ children, currentPage, userName, userEmail }: AccountLayoutProps) {
  const menuItems = [
    { href: '/account', label: 'Overview', icon: 'grid' },
    { href: '/account/landlord', label: 'Landlord', icon: 'building' },
    ...
    { href: '/account/communication', label: 'Communication', icon: 'message' },
  ];
